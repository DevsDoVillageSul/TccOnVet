        ...
        <div class="card">
            <div class="card-header">
                ...
                <div style="float: right;">
                    <a href="{{ url('protocolos/inducoes/create/0') }}" class="btn btn-outline-primary waves-effect">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                <a href="{{ url('protocolos/inducoes/create') }}/{{ $inducao->id ?? null }}"
                                ...
                                <a  href="javascript:void(0);" class="btn btn-icon btn-outline-warning waves-effect" 
                                   ...
                                   onclick="deleteItem('{{ url('protocolos/inducoes/delete') }}/{{ $inducao->id ?? null }}');"
                                >
            ...
            @include('shared.paginate', ['form' => 'formSearch', 'itens' => $inducoes ?? null])
        </div>
    </div>
</div>
@endsection