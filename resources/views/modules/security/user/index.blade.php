                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td nowrap>
                                        <a href="{{ url('security/users/create') }}/{{ $user->id }}" class="btn btn-icon btn-outline-primary waves-effect" title="Editar">
                                            <i data-feather="edit-2"></i>
                                        </a>
                                        <a href="javascript:void(0);" class="btn btn-icon btn-outline-warning waves-effect" alt="Apagar" title="Apagar" {{-- @if($role->users_count > 0)
